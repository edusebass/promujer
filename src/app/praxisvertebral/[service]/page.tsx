...
import { SERVICIOS_PR_VER as informacion } from "@/constants/servicios_descrip";
...
export async function generateMetadata({
  ...
  return {
    title,
    description:
      "Servicios especializados en praxis vertebral para corregir la alineación de la columna y tratar problemas como la rectificación cervical y el estrés vertebral. Mejora tu postura y bienestar con nuestros tratamientos personalizados en Termo Oasis.",
    icons:
...
const PraxisVertebral = ({ params }: { params: { service: string } }) => {
  const { service } = params;
...
export default PraxisVertebral;
