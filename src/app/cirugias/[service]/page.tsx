...
import { SERVICIOS_CIRUGIAS as informacion } from "@/constants/servicios_descrip";
...
const Cirugias = async ({ params }: any) => {
    const { service } = await params;
    return (
        <>
            <section
            ...
            <section className="flex flex-col w-10/12 mx-10 md:mx-16 bg-white p-3">
                <div className="bg-colorTextSecondary mt-16 mb-5 p-5">
                    ...
                    <p>Información sobre el procedimiento</p>
                </div>
            ...
            <AnimatedVideoSection
                ...
                introText={`Las cirugías ginecológicas permiten tratar diversas patologías con técnicas seguras y efectivas. La evaluación personalizada determina la mejor alternativa para cada paciente.`}
            />
        </>
    );
};
