...
const NavbarMoviles = ({
  ...
  return (
    <div className="md:hidden absolute top-[55px] left-0 w-full bg-lightBlue shadow-md z-50">
      <div className="flex flex-col items-start p-4">
        ...
        <div className="py-2 w-full">
          <div
            className={`flex flex-row justify-start pb-2 border-b border-white items-center ${
              openSubMenu === "fisioterapia"
                ? "bg-blue text-extraWhite p-2"
                : ""
            }`}
          >
            <button
            ...
            <FaAngleDown
              className={`transform transition-transform duration-300 ${
                openSubMenu === "fisioterapia" ? "rotate-180" : ""
              }`}
            />
          </div>
          <div
            className={`overflow-hidden transition-all duration-1000 ${
              openSubMenu === "fisioterapia" ? "max-h-screen" : "max-h-0"
            }`}
          >
            {openSubMenu === "fisioterapia" && (
              <div className="pl-4">
        ...
        <div className="py-2 w-full">
          <div
            className={`flex flex-row justify-start pb-2 border-b border-white items-center ${
              openSubMenu === "quiropraxia" ? "bg-blue text-extraWhite p-2" : ""
            }`}
          >
            <button
              className="w-full text-left"
            ...
            <FaAngleDown
              className={`transform transition-transform duration-300 ${
                openSubMenu === "quiropraxia" ? "rotate-180" : ""
              }`}
            />
          </div>
          <div
            className={`overflow-hidden transition-all duration-1000 ${
              openSubMenu === "quiropraxia" ? "max-h-screen" : "max-h-0"
            }`}
          >
        ...
        <div className="py-2 w-full">
          ...
          >
            ...
            <FaAngleDown
              className={`transform transition-transform duration-300 ${
                openSubMenu === "praxisVertebral" ? "rotate-180" : ""
              }`}
            />
          </div>
          <div
            className={`overflow-hidden transition-all duration-1000 ${
              openSubMenu === "praxisVertebral" ? "max-h-screen" : "max-h-0"
            }`}
          >
            {openSubMenu === "praxisVertebral" && (
              <div className="pl-4">
        ...
        <div className="py-2 w-full">
          <div
            className={`flex flex-row justify-start pb-2 border-b border-white items-center ${
              openSubMenu === "tkEmocional" ? "bg-blue text-extraWhite p-2" : ""
            }`}
          >
            <button
              className="w-full text-left"
            ...
            <FaAngleDown
              className={`transform transition-transform duration-300 ${
                openSubMenu === "tkEmocional" ? "rotate-180" : ""
              }`}
            />
          </div>
          <div
            className={`overflow-hidden transition-all duration-1000 ${
              openSubMenu === "tkEmocional" ? "max-h-screen" : "max-h-0"
            }`}
          >
        ...
        <div className="py-2 w-full">
          ...
          >
            ...
            <FaAngleDown
              className={`transform transition-transform duration-300 ${
                openSubMenu === "otrosServicios" ? "rotate-180" : ""
              }`}
            />
          </div>
          <div
            className={`overflow-hidden transition-all duration-1000 ${
              openSubMenu === "otrosServicios" ? "max-h-screen" : "max-h-0"
            }`}
          >
            {openSubMenu === "otrosServicios" && (
              <div className="pl-4">
      ...
      <div className="bg-orange flex justify-center items-center">
        <a
          target="_blank"
